...
public class EditDepartmentPage {
    ...
    private By deleteDepartmentButton2 = By.xpath("//button[text()='Delete Department']");
    ...
    private String savedDepartmentName; //feature'de gönderilen name'i burada kaydediyorum ki sonra dogrulamas yapmakta kullanabileyim
    ...
    public EditDepartmentPage selectDepartmentType(String type) {
        ReusableMethods.visibilityOfElementByWebDriverWait(pages.getNewDepartmentPage().getDepartmentTypeField());
        actions.click(getDriver().findElement(pages.getNewDepartmentPage().getDepartmentTypeField())).perform();
